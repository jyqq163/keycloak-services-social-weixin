...
public class WeiXinIdentityProvider extends AbstractOAuth2IdentityProvider<OAuth2IdentityProviderConfig>
    ...
    protected BrokeredIdentityContext extractIdentityFromProfile(EventBuilder event, JsonNode profile) {
        ...
        logger.info("set user avatar to:" + avatar);
        ...
        if (UserAgentHelper.isWechatBrowser(ua)) {// 是微信浏览器
            ...
            if (config instanceof WeixinIdentityProviderConfig) {
                ...
                if (customizedLoginUrlForPc != null && !customizedLoginUrlForPc.isEmpty()) {
                    logger.info("----------customized login url for pc");
                    logger.info("clientId: " + config.getConfig().get(WECHAT_MP_APP_ID));
                    logger.info("state: " + request.getState().getEncoded());
                ...
                logger.info("----------default");
                logger.info("clientId: " + config.getClientId());
    ...
    protected static class Endpoint {
        ...
        private final WeiXinIdentityProvider provider;
        ...
        public Endpoint(AuthenticationCallback callback, RealmModel realm, EventBuilder event, WeiXinIdentityProvider provider) {
            ...
            this.customAuth = provider.customAuth;
        }

        public OAuth2IdentityProviderConfig getConfig() {
        ...
        public Response authResponse(@QueryParam(AbstractOAuth2IdentityProvider.OAUTH2_PARAMETER_STATE) String state,
            ...
            @QueryParam(OAuth2Constants.ERROR) String error, @QueryParam(OAuth2Constants.SCOPE_OPENID) String openid,
            ...
            if (error != null) {
                if (error.equals(ACCESS_DENIED)) {
                    ...
                    return callback.error(getConfig(), state + " " + Messages.IDENTITY_PROVIDER_UNEXPECTED_ERROR);
                }
            }
            ...
            try {
                ...
                if (authorizationCode != null) {
                    ...
                    federatedIdentity = provider.getFederatedIdentity(response, wechatLoginType, accessTokenResponse);
        ...
        private Response authenticated(BrokeredIdentityContext federatedIdentity) {
            ...
            weiXinIdentityBrokerService.init(session, clientConnection, event, httpRequest);
