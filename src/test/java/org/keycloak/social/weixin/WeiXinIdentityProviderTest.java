...
public class WeiXinIdentityProviderTest {
    ...
    public void pcGoesToQRConnect() {
        IdentityBrokerState state = IdentityBrokerState.decoded("state", "clientId", "clientId", "tabId", "clientData");
        ...
        Assert.assertEquals("pc goes to customized login url", "https://open.weixin.qq" +
                ...
                ".Y2xpZW50SWQ.clientData&appid=clientId&redirect_uri=https%3A%2F%2Fredirect.to" +
    ...
    void getFederatedIdentityForWMP() throws JsonProcessingException {
        ...
        var expectedUser = new BrokeredIdentityContext(sut.getJsonProperty(expectedJsonProfile, "unionid"), config);
